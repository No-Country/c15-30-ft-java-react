...
const Tecnologia = require('./tecnologia.model.js');
...
Proyecto.belongsToMany(Tecnologia, {through: "proyectos_tecnologias"});
Tecnologia.belongsToMany(Proyecto, {through: "proyectos_tecnologias"});
