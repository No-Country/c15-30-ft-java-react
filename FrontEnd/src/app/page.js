  ...
  return (
    <div className="pt-20">
      ...
      <div className="w-screen overflow-x-hidden flex flex-col items-center gap-[10px] md:mt-16">
        <br />
        <br />
        <section className="grid justify-center items-center gap-[10px] md:grid-cols-2 md:grid-rows-2">
          <div className="flex flex-col justify-center items-center gap-[10px] md:col-start-2 md:col-end-3">
            <TitleContainer
              type={"sectionTitle"}
          ...
          <div className="md:col-start-1 md:col-end-2 md:row-start-1 md:row-end-3 md:place-self-start">
          <ImageContainer
            size={"lg"}
          ...
          <div className="flex flex-col items-center gap-[10px]  md:col-start-2 md:col-end-3">
            <TitleContainer
        ...
        <section className="hidden md:flex md:flex-col h-[1000px]">
          seccion de scroll
        </section>
        ...
        <ScrollArea className="flex w-[400px] md:w-full  mb-10 ">
          <div className="flex space-x-4 gap-5 py-2 px-2 md:flex md:justify-center">
            <Testimonials />
            <Testimonials />
            <Testimonials />
            <Testimonials />
